...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.viewcode','sphinx.ext.todo','sphinx.ext.autosummary','sphinxcontrib.blockdiag' ,'sphinx.ext.pngmath','rst2pdf.pdfbuilder']
# Fontpath for blockdiag (truetype font)
#blockdiag_fontpath = '/usr/share/fonts/truetype/freefont/FreeSerif.ttf'
